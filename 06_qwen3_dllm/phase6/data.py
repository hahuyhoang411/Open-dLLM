...
def get_batch(split, cfg, loader=None):
    ...
    x_input = x_input.to(cfg.device, non_blocking=_nb)
    targets = targets.to(cfg.device, non_blocking=_nb)
    noise_mask = noise_mask.to(cfg.device, non_blocking=_nb)
    elbo_w = elbo_w.to(cfg.device, non_blocking=_nb)
    doc_ids = doc_ids.to(cfg.device, non_blocking=_nb)
    positions = positions.to(cfg.device, non_blocking=_nb)
